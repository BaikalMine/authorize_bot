...
func TestIsKnownSpamMessageDetectsDeletedAccountQuoteBait(t *testing.T) {
	message := &tgbotapi.Message{Text: "\u0420\u0430\u0431\u0431\u0431\u0431\u043e\u043e\u043e\u0447\u0438\u0439"}

	if !isKnownSpamMessage(message) {
		t.Fatal("expected deleted account quote bait to be detected")
	}
}

func TestIsKnownSpamMessageDetectsNordVPNQuotePayload(t *testing.T) {
	message := &tgbotapi.Message{Text: "NordVPN - \u0411\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u044b\u0439 \u0412\u041f\u041d. NordVPN \u2014 \u0432\u0430\u0448 \u0431\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u044b\u0439 \u043f\u0440\u043e\u043f\u0443\u0441\u043a \u0432 \u043d\u043e\u0440\u043c\u0430\u043b\u044c\u043d\u044b\u0439 \u0438\u043d\u0442\u0435\u0440\u043d\u0435\u0442."}

	if !isKnownSpamMessage(message) {
		t.Fatal("expected NordVPN quote payload to be detected")
	}
}

func TestIsKnownSpamMessageAllowsOrdinaryWorkingWord(t *testing.T) {
	message := &tgbotapi.Message{Text: "\u0440\u0430\u0431\u043e\u0447\u0438\u0439 \u0433\u0440\u0430\u0444\u0438\u043a \u043d\u0430 \u043d\u0435\u0434\u0435\u043b\u044e"}

	if isKnownSpamMessage(message) {
		t.Fatal("expected ordinary working-word message to be allowed")
	}
}

func TestIsKnownSpamMessageAllowsPlainWorkingToken(t *testing.T) {
	message := &tgbotapi.Message{Text: "\u0440\u0430\u0431\u043e\u0447\u0438\u0439"}

	if isKnownSpamMessage(message) {
		t.Fatal("expected plain working-word token to be allowed")
	}
}
